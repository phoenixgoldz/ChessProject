...
namespace SharpChess
{
    ...
    public class frmMain : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // sbr
            // 
            this.sbr.Location = new System.Drawing.Point(0, 800);
            this.sbr.Name = "sbr";
            this.sbr.Size = new System.Drawing.Size(1138, 24);
            ...
            this.tbr.Size = new System.Drawing.Size(1138, 32);
            ...
            this.ClientSize = new System.Drawing.Size(1138, 824);
        ...
        private void RenderBoard()
        {
            ...
            if (Game.PlayerToPlay == Game.PlayerWhite)
            {
                ...
                {
                    Console.WriteLine($"[ERROR] RenderBoard failed: {ex.Message}");
                }
            }
            else
            {
        ...
        {
            // Add Chess960 selection BEFORE opening difficulty settings
            DialogResult result = MessageBox.Show(
                "Select Game Mode:\n\nYes - Traditional Chess\nNo - Chess960",
                "Choose Game Mode",
            ...
            {
                Console.WriteLine("[DEBUG] Starting Traditional Chess...");
                Game.CurrentMode = Game.ChessMode.Traditional;
            }
            else
            {
                Console.WriteLine("[DEBUG] Starting Chess960...");
                Game.CurrentMode = Game.ChessMode.Chess960;
            }

            // ✅ Call the existing function that starts a new game
            StartNormalGame();  // <-- Replace with the correct function
        }
